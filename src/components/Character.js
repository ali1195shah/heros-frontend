...
const Character = (props) => {
  ...
  const bgColor =  props.character.alignment === 'good' ? 'blue' : 'red' 
    return (
      <div id={ props.character.id } className="ui column">
      <div className="card">
        <div className="ds-top" style={{backgroundColor: `${bgColor}`, width: '90%'}}></div>
        ...
        <div className="ds-skill">
          ...
          <div className="skill html">
            ...
            <div className="bar bar-html" style={{width: `${ props.character.intelligence }%`, backgroundColor: `${bgColor}`}}>
              <p>{props.character.intelligence}</p>
            </div>
          </div>
          <div className="skill css">
            <h6><i className="fab fa-css3-alt"></i>Strength</h6>
            <div className="bar bar-css" style={{width: `${ props.character.strength }%`, backgroundColor: `${bgColor}`}}>
              <p>{ props.character.strength }</p>
            </div>
          </div>
          <div className="skill javascript">
            <h6><i className="fab fa-js"></i>Speed</h6>
            <div className="bar bar-js" style={{width: `${ props.character.speed }%`, backgroundColor: `${bgColor}`}}>
              <p>{ props.character.speed }</p>
            </div>
          </div>
          <div className="skill javascript">
            <h6><i className="fab fa-js"></i>Durability</h6>
            <div className="bar bar-js" style={{width: `${ props.character.durability }%`, backgroundColor: `${bgColor}`}}>
              <p>{ props.character.durability }</p>
            </div>
          </div>
          <div className="skill javascript">
            <h6><i className="fab fa-js"></i>Power</h6>
            <div className="bar bar-js" style={{width: `${ props.character.power }%`, backgroundColor: `${bgColor}`}}>
              <p>{ props.character.power }</p>
            </div>
          </div>
          <div className="skill javascript">
            <h6><i className="fab fa-js"></i>Combat</h6>
            <div className="bar bar-js" style={{width: `${ props.character.combat }%`, backgroundColor: `${bgColor}`}}>
